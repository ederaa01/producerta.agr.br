...
//    $("#intro").backstretch("images/header-background.jpg");
    ...
    map = new GMaps({
        ...
        lat: -24.7571077,
        lng: -51.767044,
        html: "Producerta Matriz<br/> Sede Administrativa",
        zoom: 15,
        zoomControl: true,
...
//        content: '<i class="fa fa-map-marker"></i>',
    ...
    map.addMarker({
        lat: map.getCenter().lat(),
        lng: map.getCenter().lng(),
        title: 'Producerta Matriz, Av. Getúlio Vargas, 559',
        infoWindow: {content: '<p>Producerta Matriz</p>'},
        icon: {url: "favicon.png",
            iconsize: [50, 50],
            iconanchor: [1, 3],
            infowindowanchor: [2, 0]
        }
    });
    ...
    map.addMarker({
        ...
        lng: -51.7717842,
        title: 'Cerealista',
        infoWindow: {content: '<p>Producerta Cerealista</p>'},
        icon: {url: "favicon.png",
            iconsize: [50, 50],
            iconanchor: [1, 3],
            infowindowanchor: [2, 0]
