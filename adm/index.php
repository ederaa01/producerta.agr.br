...
<html lang="pt-br">
    <head>
        ...
        <meta name="description" content="Administração do site.">
                ...
                <div class="row-fluid">
                    <div class="well span5 center login-box">
                        <div class="alert alert-info">
                            Por favor faça seu login com seu usuário e senha.
                        </div>
                        <form class="form-horizontal" action="verifica.php" method="post">
                            <fieldset>
                                ...
                                <div class="input-prepend">
                                    ...
                                    <input type="checkbox" id="remember" />Lembrar-me</label>
                                </div>
                                <div class="clearfix"></div>
