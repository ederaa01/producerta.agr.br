...
//        session_start();
    ...
    public function initVisit($timeLife = null) {
        $_SESSION['ACTIVITY_ID_VISIT'] = md5(uniqid(time()));
        $_SESSION['LAST_ACTIVITY_VISIT'] = time();
        if ($timeLife != null) {
            $_SESSION['LIFE_TIME_VISIT'] = $timeLife;
        } else {
            $_SESSION['LIFE_TIME_VISIT'] = 1800;
        }
    }
    ...
    public function checkVisit() {
        return isset($_SESSION['ACTIVITY_ID_VISIT']);
    }
    ...
    public function getId() {
        if (isset($_SESSION['ACTIVITY_ID_VISIT'])) {
            return $_SESSION['ACTIVITY_ID_VISIT'];
